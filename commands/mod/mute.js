...
module.exports = {
    ...
    run: async (bot, message, args) => {
        try {
            ...
            if (!args[0]) return message.channel.send("**<:error:897857752276299797> Error :- Please Enter A User To Be Muted!**\n`usage :- _mute [user]`");
          ...
          try {
            mutee.roles.set([muterole.id]).then(() => {
                ...
                const sembed = new MessageEmbed()
                    ...
                    .setDescription(`${mutee.user.username} was successfully muted for ${reason}<:greentick:897041996949123092> `)
