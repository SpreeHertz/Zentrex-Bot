...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!message.member.permissions.has(Permissions.FLAGS.BAN_MEMBERS)) return message.channel.send("**You Dont Have The Permissions To Unban Someone! - [BAN_MEMBERS]**")

        if (!args[0]) return message.channel.send("**<:error:897857752276299797> ERROR :- Please Enter A ID!**\n`usage :- _unban [user id]`")
